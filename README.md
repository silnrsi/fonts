...
- **If you want to develop fonts or contribute to SIL font projects** see [Font Design & Development](https://writingsystems.info/topics/fonts/font-design-and-development/) and [Building & Modifying SIL Fonts](https://writingsystems.info/topics/fonts/building-and-modifying-sil-fonts/).
...
All other contents, except where noted, are Copyright (c) 2021-2026, [SIL Global](http://www.sil.org) and released under the MIT license - see [LICENSE](https://github.com/silnrsi/fonts/blob/main/LICENSE).
