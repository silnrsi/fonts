...
Please send us your requests using the [form on the SIL software website](https://software.sil.org/support/). If you are interested in helping us make the fonts better see the [Developer](developer) page.
