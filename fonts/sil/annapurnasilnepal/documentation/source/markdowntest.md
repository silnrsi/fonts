...
Links whose text includes @ - such as for X (formerly Twitter) - need to have the @ escaped by adding a preceding backslash, as in `X [\@silfonts](https://x.com/silfonts)`.
