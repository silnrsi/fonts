...
This project is intended to provide a free and open font family for languages and writing systems that use the Lisu (Fraser) script. It supports the complete range of Unicode characters for the script.

The regular weight design is based on [LisuTzimu Regular](https://github.com/silnrsi/font-lisutzimu) (Copyright (c) 1998-2019 David Morse). Other weights, including italics, are new. The Latin script glyphs are intended to contrast strongly from the Lisu and are based on [Source Serif](https://github.com/adobe-fonts/source-serif) (Copyright (c) 2014-2019 Adobe).

## Future plans

These fonts are actively maintained and improved. The highest priorities for future additions and enhancements are mainly driven by:
